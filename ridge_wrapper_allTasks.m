...
for tasknum = 1:length(taskname)
    ...
    save([homedir dataset '/results/superLowMotion/',dataset, '_', taskname{tasknum} '_ridge_p',num2str(thresh),'_' num2str(numiter) 'iters_' num2str(k) 'fold_' savename '_prediction_noGSR_withCue.mat'],'q_s','r_pearson','r_rank','y','coef_total','coef0_total','lambda_total','beta_order','seeds','-v7.3');
